/** Shared Tailwind class strings — restrained, document-style UI. */
...
export const inputClass =
  [
    "mt-1.5 w-full min-h-11 rounded-lg border border-stone-200 bg-white px-3.5 py-2.5 text-base text-stone-900",
    ...
    "max-sm:mt-1 max-sm:min-h-10 max-sm:rounded-md max-sm:px-3 max-sm:py-2 max-sm:text-sm",
  ].join(" ");
...
export const toolbarWell =
  "rounded-xl border border-stone-200 bg-stone-50/80 p-1.5 shadow-sm shadow-stone-900/[0.03]";
